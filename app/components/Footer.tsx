...
export default function Footer() {
  return (
    <footer className="max-w-screen-2xl mx-auto p-2 md:p-4 text-center text-sm text-text sm:grid sm:grid-cols-3 w-full">
      ...
      <div className="sm:text-right mb-3 sm:mb-0">
