    ...
    <>
      ...
      <div className="max-w-screen-2xl mx-auto w-full p-4 sm:p-8 pt-10 pb-10 grid grid-cols-1 md:grid-cols-4" id="about-me">
        <div className="md:col-span-3 md:pr-5">
          ...
          <p className="mb-4">When I first started programming in 2014, at the age of thirteen, using only a Raspberry Pi and my parent&apos;s TV, I wanted to learn everything there is to know about computers. Now, ten years later, I am a lot more knowledgeable and getting closer to finishing my bachelor&apos;s degree in Media Informatics, but I can confidently say that I have not achieved my na&iuml;ve goal and likely never will.</p>
