      ...
      <div className="bg-gradient-to-b from-gray-50 to-red-50">
        <div className="max-w-screen-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="md:min-h-96 md:pr-8 md:pb-10 md:pt-10 md:pl-2 order-1 md:order-2">
            <img src="https://static.simonludwig.com/images/main-lg.jpg" alt="A portrait of Simon Ludwig" className="object-cover w-full md:h-full aspect-photo object-35 md:aspect-square" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-screen-2xl mx-auto w-full p-4 sm:p-8 pt-10 pb-10 grid grid-cols-1 md:grid-cols-4" id="about-me">
        ...
        <div>
          <div className="mt-7 md:mt-0 md:pl-5">
            <img src="https://static.simonludwig.com/images/about-me.jpg" alt="A portrait of Simon Ludwig" className="object-cover aspect-square w-full h-full rounded-full" /><br />
            <p className="text-center text-xs text-gray-500">Photo: &copy; 2024 foto b. k&uuml;pper</p>
          </div>
        </div>
      </div>
    </>
