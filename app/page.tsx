    ...
    <>
      ...
      <div className="max-w-screen-2xl mx-auto w-full p-4 pt-10 pb-10 grid grid-cols-1 md:grid-cols-4" id="about-me">
        <div className="md:col-span-3 md:pr-5">
          ...
          <p className="mb-4">Additionally, I am very passionate about music. I play the guitar, the trombone, the trumpet and the piano in local bands and orchestras and I love producing music, which I have done as part of my studies as well. I am also curious about music production software and algorithms, but my university does not offer courses in this field for bachelor students and I have therefore not been able to fully devote myself to this subject area yet.</p>
